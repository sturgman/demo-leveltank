module MyPlot exposing (fixedRangePlot, myaxis, myseries, pltheight, pltwidth, shiftedLabel, shiftedLabel2, smallcircle, tickintervalx, ticklocationsx, xaxis)
...
shiftedLabel2 position =
    { position = position
    , view = P.viewLabel [ SA.dy "-1em" ] (String.fromFloat position)
    }
